...
@section("main")
    <section x-data="{ openModal: false, selectedMovie: null }" class="p-6">
        ...
        <div x-show="openModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75 p-4" @click="openModal = false">
            <div @click.stop 
                 class="bg-gray-800 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                
                <template x-if="selectedMovie">
                    <div class="flex flex-col md:flex-row">

                        <div class="md:w-1/3 flex-shrink-0">
                            <img :src="'{{ asset('storage/movies/') }}/' + selectedMovie.image" 
                                 :alt="selectedMovie.name"
                                 class="w-full h-auto rounded-t-2xl md:rounded-l-2xl md:rounded-tr-none object-cover">
                        </div>
                        ...
                        <div class="p-6 md:p-8 flex-1">
                            ...
                            <div class="space-y-3 text-gray-300">
                                ...
                                <div>
                                    <span class="font-semibold text-white">Age limit:</span>
                                ...
                                <div>
                                    <span class="font-semibold text-white">Premiere date:</span>
                                ...
                                <div>
                                    <span class="font-semibold text-white">Sound:</span>
                                    <span x-text="selectedMovie.sound"></span>
                                </div>
                            </div>
                            
                            <button @click="openModal = false" 
                                    class="mt-6 px-6 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-semibold">
                                Close
                            </button>
                        </div>
                    </div>
